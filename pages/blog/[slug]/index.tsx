      ...
      <section>
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <div className="w-3/4 h-fit block mx-10 my-5 max-h-96 font-serif text-black   p-24 uppercase text-center justify-center">
            ...
            esse quod iure ex debitis, qui ratione possimus cumque unde autem
            consequuntur aliquam, sit libero doloremque magnam corporis itaque.
            Excepturi, adipisci.
          </div>
        </div>
        ...
        <div className="w-full flex flex-col justify-center items-center">
          ...
          >
            <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
              ...
              >
                <img
                  src="https://photo.znews.vn/w1920/Uploaded/yqdxwpujv/2023_04_05/COVER_1_ZING_copy.jpg"
              ...
              >
                <img
                  src="https://photo.znews.vn/w1920/Uploaded/kbfoplb/2023_05_16/DSC_9861_zing_1.jpg"
                  className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                  alt="..."
                />
              </div>
